...
public class CartServiceImpl implements ICartService {
    ...
    @Override
    public void reduceToCart(Integer cid, Integer uid, String username) {
        ...
        if (num < 1) {
            removeCartItem(cid, uid, username);
        } else {
    ...
    private void removeCartItem(Integer cid, Integer uid, String username) {
    }
    @Override
